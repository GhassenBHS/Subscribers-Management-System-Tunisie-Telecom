...
?>
  ...
  <form action="traitement_nv_ligne_msan.php" method ="post"> 

<p>
<label class="no">Numéro de l'abonné</label> <input class="s1" type="text" name="NUM" /> <br /><br /><br />
<label class="no">Adresse IP</label>
<select class="s1" name="choix_ip">
 <option value="172.24.3.156">172.24.3.156</option>
  <option value="172.24.3.157">172.24.3.157</option>
   <option value="172.24.3.158">172.24.3.158</option>
   <option value="172.24.3.159">172.24.3.159</option>
   <option value="172.24.3.163">172.24.3.163</option>
   <option value="172.24.240.4">172.24.240.4</option>
   <option value="172.24.240.8">172.24.240.8</option>
...
<label class="no">TID</label> <input class="s1" type="text" name="tid" /> <br /><br /><br />

<label class="no">Nature</label> <input class="s1" type="text" name="nature" /> <br /><br /><br />
<label class="no">Reg</label> <input class="s1" type="text" name="reg" /> <br /><br /><br />
<label class="no">Eqt</label> <input class="s1" type="text" name="eqt" /> <br /><br /><br />
<label class="no">Data</label> <input class="s1" type="text" name="data" /> <br /><br /><br />
<label class="no">Slot_D</label> <input class="s1" type="text" name="slot_D" /> <br /><br /><br />
<label class="no">Port_D</label> <input class="s1" type="text" name="port_D" /> <br /><br /><br />
...
<input class="s1" type="submit" name="valider" value="Ajouter entrée" /><br />
