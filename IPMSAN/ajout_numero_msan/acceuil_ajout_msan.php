...
<html>
    <head>
        ...
        <title>Ajout IPMSAN</title>
    </head>
 <body>
  <h1 >Page d'ajout d'un abonné dans la base IPMSAN</h1>
...
?>
  ...
  <form action="ajout_abonne_msan.php" method ="post"> 
...
<select class="s1" name="choix_msan">
...
<label class="no">Reference</label> <input class="no" type="text" name="Ref" /> <br /><br /><br />
<input class="s1" type="submit" name="valider" value="Ajouter" /><br />
</p>
