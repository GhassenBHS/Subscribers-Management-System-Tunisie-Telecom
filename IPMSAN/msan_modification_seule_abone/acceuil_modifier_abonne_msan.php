...
<html>
    ...
    <body>
	 <h1>Modification d'un Abonné dans la base de donnée IPMSAN </h1>
...
?>
     ...
     <p>Bonjour et bienvenue !
            Cette page vous permet de modifier l'état d'un abonné dans la base de donnée IPMSAN . <br />
			Pour cela il faut spécifier chacune des <strong ><em>critères</strong> ci dessous  :
    </p>
	


<form action="traitement_modifier_abonne_msan.php" method ="post"> 
